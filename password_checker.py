...
def request_api_data(query_char):
    ...
    if res.status_code != 200:
        raise RuntimeError(f'Error Frethching :{res.status_code},check the api & try again')
    return res
...
def pwned_api_check(password):
    # check password is exisits in the api
...
def main(args):
    for password in args:
        ...
        if count:
            ...
            print(f'{password} was not found , This is a good password')
    return 'done'
